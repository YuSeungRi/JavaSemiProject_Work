...
<div class="container m-3">
	<h1>
		<span class="fa fa-bullhorn fa-fw mr-1"></span>공지사항
	</h1>
	<div class="col mt-1">
		<div class="col-mt-11">
			<form>
			...
			<div class="row justify-content-center">
				<div class="col-3 text-center m-1">
					<%-- 작성 버튼 --%>
					<a href="/notice/write.do" class="btn btn-secondary btn-sm active" role="button" aria-pressed="true">작성</a>
				</div>
			</div>	
			<div class="row justify-content-center">
				<div class="col m-4">
					<%-- 페이지네이션 --%>
					<jsp:include page="../util/noticePaging.jsp" />
				</div>
			</div>
		</div>
