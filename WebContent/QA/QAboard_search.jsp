...
<div class="container m-3">
	<h1>
		<span class="fa fa-laptop fa-fw mr-1"></span>Q&A 게시판 검색결과
	</h1>
	<div class="col mt-1">
		<div class="col-mt-11">
			...
			<div class="row justify-content-center">
				<div class="col-3 text-center m-1">
					<%-- 게시판으로 돌아가기 버튼 --%>
					<a href="/question/Q&A.do" class="btn btn-secondary btn-sm active" role="button" aria-pressed="true">돌아가기</a>
				</div>
			</div>	
			<div class="row justify-content-center">
				<div class="col m-4">
					<%-- 페이지네이션 --%>
					<jsp:include page="/util/questionsearchPaging.jsp" />
				</div>
			</div>
		</div>
