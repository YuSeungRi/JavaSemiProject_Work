...
//		String user = (String) request.getSession().getAttribute("userNick"); // 아직 UserInfoDao 에 메소드 구현 x
		...
		System.out.println(user); // UserInfoDao 메소드 구현할 때까지 임시로 쓰기
		
		request.getRequestDispatcher("/notice/noticeboard_write.jsp").forward(request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dto.setBoardCategory("NoticeBoard");
